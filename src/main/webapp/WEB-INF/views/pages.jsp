...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                <!-- 0419連結待修改 -->
                <a class="nav-link collapsed" href="<c:url value='pages.jsp' />">
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <a href="<c:url value='module.jsp' />" class="text-decoration-none">
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <a href="<c:url value='module-1.jsp' />"  class="text-decoration-none">
                                                <div class="h4 mb-0 font-weight-bold text-center">##班表查詢</div>
                                            </a>
                                        </div>
                                        <div class="col-auto">
                                            <i class="fas fa-calendar fa-2x text-gray-300"></i>
