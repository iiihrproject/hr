...
<html lang='en'>
  <head>
    <meta charset='utf-8' />
    <link href="<c:url value='/css/scheduler/main.min.css' />" rel='stylesheet' type="text/css"/>
...
// console.log(emp)}
  document.addEventListener('DOMContentLoaded', function() {
    ...
    var calendar = new FullCalendar.Calendar(calendarEl, {
      ...
      resources: [
        { id: 'a', title: '人員 A', eventColor: 'red'  },
        { id: 'b', title: '人員 B', eventColor: 'orange' },
        { id: 'c', title: '人員 C', eventColor: 'yellow' },
        { id: 'd', title: '人員 D', eventColor: 'green' },
        { id: 'e', title: '人員 E'},
        { id: 'f', title: '人員 F', eventColor: 'indigo' },
        { id: 'g', title: '人員 G', eventColor: 'purple'   }
      ],
      events: [
        { id: '1', resourceId: 'b', start: '2021-08-06T09:00:00', end: '2021-08-06T12:00:00', title: '專案規劃' },
        { id: '2', resourceId: 'c', start: '2021-08-06T09:00:00', end: '2021-08-06T22:00:00', title: '前端' },
        { id: '3', resourceId: 'd', start: '2021-08-08T09:00:00', end: '2021-08-08T22:00:00', title: '後端' },
        { id: '4', resourceId: 'e', start: '2021-08-06T09:00:00', end: '2021-08-06T16:00:00', title: '整合' },
        { id: '5', resourceId: 'f', start: '2021-08-06T09:30:00', end: '2021-08-06T15:30:00', title: '後端' }
      ],
      drop: function(arg) {
